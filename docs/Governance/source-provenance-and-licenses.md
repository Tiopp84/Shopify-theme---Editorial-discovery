...
| GSAP Core + ScrollTrigger | `https://www.npmjs.com/package/gsap`, version `3.13.0`, imported 2026-07-28 | GSAP Standard “No Charge” License | Uncommitted working tree | APPROVED â€” self-hosted runtime retained for future scoped motion; currently inactive. Core 72 KB + ScrollTrigger 44 KB minified; remove the two assets and register entries to revert |
